...
class GeneralStoreApprovalDetails {
  List<ItemModel>? itemList;
  List<ApprovalFlow>? approvalFlowList;
  List<CommentModel>? commentList;
  GeneralStoreApprovalDetails({
    this.itemList,
    this.approvalFlowList,
    this.commentList,
  });

  GeneralStoreApprovalDetails copyWith({
    List<ItemModel>? itemList,
    List<ApprovalFlow>? approvalFlowList,
    List<CommentModel>? commentList,
  }) {
    return GeneralStoreApprovalDetails(
  ...
  factory GeneralStoreApprovalDetails.fromMap(Map<String, dynamic> map) {
    return GeneralStoreApprovalDetails(
  ...
  factory GeneralStoreApprovalDetails.fromJson(String source) =>
      GeneralStoreApprovalDetails.fromMap(
          json.decode(source) as Map<String, dynamic>);

  @override
  String toString() =>
      'GeneralStoreApprovalDetails(itemList: $itemList, approvalFlowList: $approvalFlowList, commentList: $commentList)';

  @override
  bool operator ==(covariant GeneralStoreApprovalDetails other) {
