...
class ServiceRequisitionDetailModel {
  ...
  ServiceRequisitionDetailModel copyWith({
    List<ItemModel>? itemList,
    List<ApprovalFlow>? approvalFlowList,
    List<CommentModel>? commentList,
  }) {
    return ServiceRequisitionDetailModel(
  ...
  factory ServiceRequisitionDetailModel.fromMap(Map<String, dynamic> map) {
    return ServiceRequisitionDetailModel(
  ...
  factory ServiceRequisitionDetailModel.fromJson(String source) =>
      ServiceRequisitionDetailModel.fromMap(
          json.decode(source) as Map<String, dynamic>);

  @override
  String toString() =>
      'ServiceRequisitionDetailModel(itemList: $itemList, approvalFlowList: $approvalFlowList, commentList: $commentList)';

  @override
  bool operator ==(covariant ServiceRequisitionDetailModel other) {
