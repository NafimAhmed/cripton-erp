...
class ICTServiceItemModel {
  ...
  factory ICTServiceItemModel.fromMap(Map<String, dynamic> map) {
    return ICTServiceItemModel(
      productName:
  ...
  factory ICTServiceItemModel.fromJson(String source) =>
      ICTServiceItemModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'ICTServiceItemModel(productName: $productName, justification: $justification, reqItemId: $reqItemId, reqItemQty: $reqItemQty, sortBy: $sortBy)';
  }

  @override
  bool operator ==(covariant ICTServiceItemModel other) {
