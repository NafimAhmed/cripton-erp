...
class ICTStoreModel {
  ...
  factory ICTStoreModel.fromMap(Map<String, dynamic> map) {
    return ICTStoreModel(
  ...
  factory ICTStoreModel.fromJson(String source) =>
      ICTStoreModel.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  bool operator ==(covariant ICTStoreModel other) {
